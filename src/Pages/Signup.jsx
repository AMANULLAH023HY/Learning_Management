...
function Signup() {
  ...
  async function createNewAccount(event) {
    ...
    if (
      ...
      toast.error(
        "Password should be 6-16 character long with atleast a number and specila character"
      );
      return;
    }
    ...
    <HomeLayout>
      <div className="flex items-center justify-center h-[90vh]">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-2 bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out 
           duration-300 rounded-sm py-2 font-semibold text-lg cursor pointer "
          >
            Create account
          </button>
